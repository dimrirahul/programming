...
#include "PotentialGeometricSequence.cc"
...
int main(int argc, char* argv[])
{
	...
	for(;;)
	{
		...
		std::cout << "# input for test " << __testnum << ": " << d << std::endl;
		std::cout.flush();

		__timer_start();

		PotentialGeometricSequence __object;
		int __actual = __object.numberOfSubsequences(d);
